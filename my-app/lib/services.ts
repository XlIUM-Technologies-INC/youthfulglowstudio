...
Perfect for all skin types—whether you're a first-timer or looking for regular maintenance, this facial adapts to what your skin needs right now. You'll leave with instantly refreshed, glowing skin.`,
    ...
    process: [
      ...
      },
      {
        step: 2,
        title: "Warm-up",
        description: "Application of a luxurious massage oil to warm the skin and improve circulation."
      },
      {
        step: 3,
        title: "Massage",
        description: "Expert hand techniques focusing on face, jawline, temples, and neck for maximum relaxation."
      },
      {
        step: 4,
        title: "Serums & Masks",
        description: "Application of hydrating serums and nourishing mask while the skin is receptive."
      },
      {
        step: 5,
    ...
    faqs: [
      {
        ...
        answer: "Yes! We use gentle techniques and can customize the pressure based on your skin type. Please inform us of any sensitivities so we can use appropriate products."
      },
      {
        question: "How often should I get a facial massage?",
        answer: "For best results, we recommend monthly treatments. However, you can enjoy this service as often as you'd like, even weekly for special occasions."
      },
      {
        question: "Will I see immediate results?",
        answer: "Absolutely! You'll notice immediate improvements in glow and skin brightness. Results continue to improve over the following days as collagen production increases."
      },
      {
        question: "Can I wear makeup after?",
        answer: "We recommend waiting 2-3 hours before applying makeup to allow the serums to fully absorb. Your skin will look beautiful even without makeup!"
      }
    ],
    aftercare: "Avoid sun exposure for 24 hours. Stay hydrated and use a gentle cleanser. Apply moisturizer morning and night. Avoid exfoliants for 48 hours.",
