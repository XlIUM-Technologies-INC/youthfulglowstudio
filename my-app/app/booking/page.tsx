  ...
  return (
    <RootLayout>
        ...
        <div className="bg-white rounded-3xl shadow-xl p-8">
          ...
          <div className="bg-gray-50 rounded-2xl p-8 min-h-96 flex items-center justify-center">
            <div className="text-center">
              <Calendar className="w-16 h-16 text-[#5A95CD] mx-auto mb-4" />
              ...
              <div className="mt-8">
                <Link
                  ...
                  className="bg-linear-to-r from-[#5A95CD] to-[#4A85BD] text-white px-8 py-4 rounded-xl font-semibold hover:shadow-lg transition-all"
                >
      ...
      <section className="max-w-6xl mx-auto px-6 py-12">
        <div className="grid md:grid-cols-3 gap-8">
          <div className="bg-white rounded-3xl shadow-lg p-8 text-center">
            <Clock className="w-12 h-12 text-[#5A95CD] mx-auto mb-4" />
          ...
          <div className="bg-white rounded-3xl shadow-lg p-8 text-center">
            <MapPin className="w-12 h-12 text-[#5A95CD] mx-auto mb-4" />
            <h3 className="text-xl font-bold mb-2">Our Location</h3>
            <p className="text-gray-600">123 Beauty Lane, Wellness City, ST 12345</p>
          </div>

          <div className="bg-white rounded-3xl shadow-lg p-8 text-center">
            <Phone className="w-12 h-12 text-[#5A95CD] mx-auto mb-4" />
      ...
      <section className="max-w-6xl mx-auto px-6 py-12 text-center">
        ...
        <Link href="/services" className="inline-block bg-[#5A95CD]/5 text-blue-700 px-8 py-4 rounded-xl font-semibold hover:bg-blue-100 transition-colors">
          View All Services
        </Link>
      </section>
    </RootLayout>
