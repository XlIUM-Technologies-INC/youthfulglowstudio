      ...
      <RootLayout>
        ...
        <section className="bg-[#112250] text-[#F5F0E9] py-24 text-center relative overflow-hidden border-b border-[#E0C58F]/20">
          ...
          <div className="relative z-10 px-6">
            ...
            >
              ...
              services, need help choosing the right treatment, or want to
              schedule an appointment, we’re here to help.
            </p>
          </div>
        </section>
        ...
        <section className="max-w-6xl mx-auto px-6 py-16">
          <div className="grid md:grid-cols-2 gap-12">
            ...
            <div className="space-y-8">
              <div>
                <h2
                  className="text-3xl font-bold mb-8 text-[#112250]"
                  style={{ fontFamily: "Playfair Display, serif" }}
                >
                  Contact Information
                </h2>
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  <h3 className="font-bold text-[#112250] mb-1">
                    Phone / Text
                  </h3>
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-[#3C507D] font-medium">
                    Expect a friendly response within 24–48 hours. If you reach
                    out during business hours, we’ll get back to you as soon as
                    possible.
                  </p>
                </div>
              </div>
            ...
            <div className="bg-white rounded-3xl shadow-2xl p-8 border border-[#E0C58F]/10">
              <p className="text-[#3C507D] mb-6 font-medium">
                Use the form below to send us a message. We'll follow up with
                all the information you need to get glowing!
              </p>
              <form className="space-y-6" onSubmit={handleSubmit}>
                <div>
                  <label className="block text-sm font-bold text-[#112250] mb-2 uppercase tracking-wide">
                    Name
                  </label>
                  <input
                    type="text"
          ...
          {/* Google Map */}
          <div className="mt-16 rounded-3xl overflow-hidden shadow-xl border border-[#E0C58F]/20 h-[400px] relative z-10">
            <iframe
              width="100%"
              height="100%"
              style={{ border: 0 }}
        ...
        <section className="bg-[#112250] py-20 text-center border-t border-[#E0C58F]/20 relative overflow-hidden">
          ...
          <div className="max-w-2xl mx-auto px-6 relative z-10">
            <h2
              className="text-3xl font-bold mb-4 text-[#E0C58F]"
              style={{ fontFamily: "Playfair Display, serif" }}
            >
              Prefer to book directly?
            </h2>
            <p className="text-[#F5F0E9]/80 mb-8 font-medium">
              Visit our services page to schedule your appointment.
            </p>
            <Link
              href="/services"
