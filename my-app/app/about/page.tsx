    ...
    <>
      ...
      <div className="bg-[#112250] text-[#F5F0E9] py-24 relative overflow-hidden border-b border-[#E0C58F]/20">
        ...
        <div className="max-w-7xl mx-auto px-6 text-center relative z-10">
          <h1 className="text-5xl md:text-6xl font-black mb-6" style={{fontFamily: 'Playfair Display, serif'}}>Who We Are</h1>
          <p className="text-xl md:text-2xl max-w-3xl mx-auto text-[#E0C58F] font-medium" style={{fontFamily: 'Cormorant Garamond, serif'}}>
            Welcome to Youth Glow Studio
          </p>
        </div>
      </div>
      ...
      <div className="max-w-6xl mx-auto px-6 py-20">
        ...
        <div className="grid md:grid-cols-2 gap-12 items-center mb-20">
          ...
          <div>
            <div className="flex items-center gap-3 mb-6">
              ...
              <h2 className="text-4xl font-bold text-[#112250]" style={{fontFamily: 'Playfair Display, serif'}}>Our Story</h2>
            </div>
            <p className="text-[#3C507D] text-lg leading-relaxed mb-6 font-medium">
              At Youth Glow Studio, we believe that skincare is more than just a routine—it's a form of self-love. 
              Founded by certified medical esthetician <span className="font-bold text-[#112250]">Marcia Edmondson</span>, 
        ...
        <div className="bg-[#F5F0E9] rounded-3xl shadow-xl p-12 mb-20 text-center border border-[#E0C58F]/20 relative overflow-hidden">
          <h2 className="text-3xl md:text-4xl font-bold text-[#112250] mb-6" style={{fontFamily: 'Playfair Display, serif'}}>Our Mission</h2>
        ...
        <div className="grid md:grid-cols-3 gap-8 mb-20">
          <div className="bg-white rounded-3xl shadow-lg p-8 text-center hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-2 border border-[#E0C58F]/10">
            ...
            <h3 className="text-2xl font-bold text-[#112250] mb-4">Professional Excellence</h3>
          ...
          <div className="bg-white rounded-3xl shadow-lg p-8 text-center hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-2 border border-[#E0C58F]/10">
            ...
            <h3 className="text-2xl font-bold text-[#112250] mb-4">Personalized Care</h3>
            <p className="text-[#3C507D] font-medium leading-relaxed">
          ...
          <div className="bg-white rounded-3xl shadow-lg p-8 text-center hover:shadow-2xl transition-all duration-300 transform hover:-translate-y-2 border border-[#E0C58F]/10">
            ...
            <h3 className="text-2xl font-bold text-[#112250] mb-4">Welcoming Environment</h3>
            <p className="text-[#3C507D] font-medium leading-relaxed">
        ...
        <div className="bg-[#112250] rounded-3xl shadow-2xl overflow-hidden border border-[#E0C58F]/20 relative">
          <div className="grid md:grid-cols-2 gap-0">
            <div className="p-12 text-[#F5F0E9] flex flex-col justify-center relative z-10">
              <h2 className="text-4xl font-bold mb-6 text-[#E0C58F]" style={{fontFamily: 'Playfair Display, serif'}}>Meet Marcia Edmondson</h2>
        ...
        <div className="text-center mt-20">
          <h3 className="text-3xl font-bold text-[#112250] mb-6" style={{fontFamily: 'Playfair Display, serif'}}>Ready to Experience the Glow?</h3>
          <p className="text-[#3C507D] font-medium text-lg mb-8 max-w-2xl mx-auto">
            Book your appointment today and discover why our clients love their experience at Youth Glow Studio.
          </p>
          <Link href="/services">
