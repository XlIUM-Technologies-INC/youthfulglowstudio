...
export default function ReviewPage() {
  ...
  return (
    <>
      <RootLayout>
      <section id="reviews" className="py-24 bg-[#F5F0E9] relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-6">
        ...
        <div className="text-center mb-16">
          <h2 className="text-4xl md:text-5xl font-black text-[#112250] mb-4" style={{fontFamily: 'Playfair Display, serif'}}>
            What Our Clients Are <span className="text-[#3C507D]">Saying</span>
          </h2>
          <div className="max-w-3xl mx-auto space-y-4">
            <p className="text-[#112250] text-lg leading-relaxed font-medium">
              At Youth Glow Studio, every client is treated with care, intention, and the goal of glowing from the inside out. Here's what some of our wonderful clients have shared about their experiences.
            </p>
            ...
            <p className="text-[#112250] font-black mt-6">
              ...
              <span className="text-sm text-[#3C507D]">These reviews are real feedback from those who've experienced our treatments</span>
            </p>
        ...
        <div className="max-w-4xl mx-auto mb-16">
          <div className="bg-white rounded-3xl p-8 md:p-12 shadow-2xl relative border border-[#E0C58F]/20">
            ...
            <div className="absolute top-8 left-8 opacity-10">
              <Quote className="w-20 h-20 text-[#112250]" fill="currentColor" />
            </div>
            ...
            <div className="flex items-center justify-center gap-4 relative z-10">
              <div>
                <h4 className="font-bold text-[#112250] text-xl text-center uppercase tracking-tight">{reviews[currentReview].name}</h4>
                <p className="text-[#E0C58F] text-sm text-center font-bold tracking-widest uppercase">{reviews[currentReview].role}</p>
                <p className="text-[#3C507D] text-xs mt-2 text-center font-medium">{reviews[currentReview].date}</p>
              </div>
            </div>
            {/* Navigation Arrows */}
        ...
        <div className="text-center mt-12">
          <p className="text-[#3C507D] mb-6 font-bold uppercase tracking-widest text-sm">Join hundreds of satisfied clients</p>
          <Link href="/services">
