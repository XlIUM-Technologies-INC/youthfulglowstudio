            ...
            <div className="grid lg:grid-cols-2 gap-12 items-center">
              ...
              <div className="space-y-8" style={{fontFamily: 'Open Sans, sans-serif'}}>
                <div className={`transition-all duration-1000 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`}>
                  <h1 className="text-5xl md:text-6xl lg:text-7xl font-bold text-gray-900 leading-tight mb-4" style={{fontFamily: 'Belleza, sans-serif'}}>
                    Glowing Skin,<br />
                    <span className="bg-gradient-to-r from-[#5A95CD] to-[#3A75AD] bg-clip-text text-transparent">
                      Graceful Aging
                    </span><br />
                    <span className="text-4xl md:text-5xl lg:text-6xl" style={{fontFamily: 'Meow Script, cursive'}}>Personalized Skincare by Marcia</span>
                  </h1>
                </div>

                <div className={`transition-all duration-1000 delay-100 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`}>
                  <div className="flex items-start gap-3 bg-white p-6 rounded-2xl shadow-lg border-l-4 border-[#5A95CD] hover:shadow-xl transition-shadow duration-300">
