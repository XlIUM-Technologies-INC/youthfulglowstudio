...
export default function AboutSection() {
  ...
  return (
    <div id="about" className="py-24 bg-gradient-to-b from-white to-[#F5F0E9] overflow-hidden">
        ...
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          ...
          >
            ...
            >
              <p className="text-[#112250] font-black text-sm uppercase tracking-widest leading-tight">
                Authentic <br /> <span className="text-[#E0C58F]">Expertise</span>
              </p>
            </motion.div>
          </motion.div>
          ...
          >
            <motion.div variants={itemVariants} className="space-y-4">
              <h2 className="text-5xl md:text-6xl font-black text-[#112250] leading-tight" style={{fontFamily: 'Playfair Display, serif'}}>
                Elevating <br />
                <span className="text-transparent bg-clip-text bg-gradient-to-r from-[#3C507D] to-[#E0C58F]">Natural Beauty</span>
              </h2>
              <div className="w-20 h-1 bg-[#E0C58F] rounded-full" />
            </motion.div>

            <motion.p variants={itemVariants} className="text-[#3C507D] text-lg md:text-xl leading-relaxed font-medium italic" style={{fontFamily: 'Cormorant Garamond, serif'}}>
              At Youth Glow Studio, every treatment is an intentional step toward self-love. We combine clinical precision with holistic care to reveal your most vibrant self.
            </motion.p>

            <div className="space-y-6">
              {[
                { title: "Years of Expert Care", desc: "Certified knowledge in advanced medical esthetics." },
                { title: "Commitment to Results", desc: "Tailored protocols for hyperpigmentation, acne, and aging." },
                { title: "Personalized Glow", desc: "Every session is uniquely crafted for your skin's biography." }
              ].map((item, i) => (
                <motion.div 
                  key={i}
                ...
                >
                  ...
                  <div>
                    <h3 className="text-lg font-black text-[#112250] mb-1 group-hover:text-[#3C507D] transition-colors">{item.title}</h3>
                    <p className="text-[#3C507D] font-medium opacity-80">{item.desc}</p>
                  </div>
                </motion.div>
              ))}
            </div>
